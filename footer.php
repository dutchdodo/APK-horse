	...
	<footer id="colophon">
		...
		<nav id="footer-menu" aria-label="Sitemap navigatie" focusable="false" class="alignfull">
		<?php
		wp_nav_menu(
			array(
				'container'       => false,
				'menu_class'      => 'grid md:grid-cols-2 gap-4',
				'submenu_class'	  => '',
		...
		<div id="companyinfo" class="alignfull grid md:grid-cols-2 gap-4">
		...
		<!-- 5. Copyright -->
		<p id="copyright">&copy; 2026 Acupunctuurpraktijk Kan</p>
